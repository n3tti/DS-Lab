...
Revision ID: 288b9da65e55
Revises: a81d7efe8893
Create Date: 2024-11-20 08:21:27.673124
...
revision: str = '288b9da65e55'
down_revision: Union[str, None] = 'a81d7efe8893'
...
def upgrade() -> None:
    ...
    sa.Column('referenced_links', sa.JSON(), nullable=True),
    sa.Column('referenced_images', sa.JSON(), nullable=True),
